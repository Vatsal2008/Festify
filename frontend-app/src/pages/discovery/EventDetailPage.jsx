  ...
  return (
    <PageShell>
      ...
      <TealBand
        variant="hero"
        style={{
          backgroundImage: `linear-gradient(180deg, rgba(8, 61, 68, 0.3) 0%, rgba(8, 61, 68, 0.68) 100%), url(${event.cover_image || 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=1200&q=85'})`,
            ...
            <div className="tiers-panel">
              ...
              {selectedTier && (
                <div className="tiers-panel__total">
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 'var(--space-sm)' }}>
                    <span className="type-body-xs" style={{ color: 'rgba(8,61,68,0.6)' }}>Platform fee (5%)</span>
                    <span className="type-body-xs" style={{ color: 'rgba(8,61,68,0.6)' }}>₹{platformFee}</span>
                  </div>
