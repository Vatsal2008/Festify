      ...
      <div className={`auth-split-card ${isSignUp ? 'auth-split-card--signup' : ''}`}>
        ...
        <div className="auth-form-side" style={{ opacity: isSignUp ? 0.3 : 1, pointerEvents: isSignUp ? 'none' : 'all' }}>
          ...
          <button className="login-google-btn" onClick={handleGoogleLogin} disabled={loading || isLoading} aria-label="Sign in with Google">
            {loading || isLoading ? (
              <span style={{ display: 'inline-block', width: 18, height: 18, border: '2px solid rgba(8,61,68,0.3)', borderTopColor: 'var(--color-ink)', borderRadius: '50%', animation: 'spin 0.6s linear infinite' }} />
            ) : (
              <>
        ...
        <div className="auth-form-side" style={{ opacity: isSignUp ? 1 : 0.3, pointerEvents: isSignUp ? 'all' : 'none' }}>
          ...
          <p className="type-body-xs" style={{ color: 'rgba(8,61,68,0.5)', textAlign: 'center' }}>
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(135deg, rgba(8, 61, 68, 0.88) 0%, rgba(8, 61, 68, 0.96) 100%), url(${HERO_BACKGROUND_IMAGE})`,
          }}
        >
          {!isSignUp ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--space-xl)' }}>
              ...
              <div>
                ...
                <p className="type-body-md" style={{ color: 'rgba(252,252,248,0.85)', maxWidth: 320, lineHeight: 1.5 }}>
  ...
  if (step === 1) return (
    <div style={{ minHeight: '100vh', background: 'var(--color-canvas)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 'var(--space-xl)' }}>
      <div className="onboarding-step">
        ...
        <p className="type-body-md" style={{ color: 'rgba(8,61,68,0.7)' }}>Please read and accept before using Festify</p>
  ...
  if (step === 2) return (
    <div style={{ minHeight: '100vh', background: 'var(--color-canvas)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 'var(--space-xl)' }}>
      <div className="onboarding-step">
        ...
        <p className="type-body-md" style={{ color: 'rgba(8,61,68,0.7)' }}>
