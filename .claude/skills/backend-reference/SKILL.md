...
description: Reference codebase for Festify backend. Use this skill when you need to understand the structure, implementation patterns, or code details of the Festify backend project.
---

# Festify backend Codebase Reference

52 files | 6114 lines | 53595 tokens
